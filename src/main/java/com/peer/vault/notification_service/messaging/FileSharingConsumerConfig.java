...
//
//        JsonDeserializer<FileShareEvent> jsonDeserializer = new JsonDeserializer<>(FileShareEvent.class);
//        jsonDeserializer.addTrustedPackages("*");
//
//        ErrorHandlingDeserializer<FileShareEvent> errorHandlingDeserializer =
